...
\documentclass[a4paper,11pt,times,numbered,index,print]{Classes/PhDThesisPSnPDF}
%\documentclass[abstract]{Classes/PhDThesisPSnPDF}
...
%\input{References/myref.bbl}
\clearpage
\input{References/myref_bbl2.tex}
