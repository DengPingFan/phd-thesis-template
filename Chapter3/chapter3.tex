...
\begin{figure}
	\centering
	\includegraphics[width=1\textwidth]{med11_update_linear.pdf}
...
The updated MED 2011 dataset has less number of training videos \ref{c2_exp_dataset}. We also verify the effectiveness of our approach on this dataset. We conduct experiments at different segment lengths including  8 s, 16 s, 32 s, 64 s, 128 s and 256 s. The overall performance is shown in the last group of Fig. \ref{f_med11_update}.
